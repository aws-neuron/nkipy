...
def test_fused_rmsnorm_gemm_nki():
    ...
    for kernel in (
        ...
        # Bridge the raw @nki.jit (beta 3) kernel into an nkipy HLO trace.
        ...
        def run_fused(x, weight, y, bias):
            return nki_op(x, weight, y, bias)

        nki_result = baremetal_jit(run_fused)(x, weight, y, bias)
