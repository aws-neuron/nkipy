...
def all_gather(data, all_gather_dim, replica_groups: Tuple[Tuple[int]], is_nkipy: bool):
...
def reduce_scatter(
    data, reduce_scatter_dim, replica_groups: Tuple[Tuple[int]], is_nkipy: bool
):
    if len(replica_groups[0]) == 1:
        return data
    # convert any list into tuple
...
def all_reduce(
    data, replica_groups: Tuple[Tuple[int]], is_nkipy: bool
):
    if len(replica_groups[0]) == 1:
        return data
    # convert any list into tuple
...
def all_to_all(
    data, split_dimension, concat_dimension, replica_groups: Tuple[Tuple[int]], is_nkipy: bool
):
    if len(replica_groups[0]) == 1:
        return data
    # convert any list into tuple
