...
from kernels.blockwise_nki import ActFnType
from config import Config


class ExpertAffinityScaleMode(Enum):
    """When expert affinities are applied (vendored; matches nkilib)."""
...
def gelu_apprx_sigmoid(x):
    """Swish/SiLU-style sigmoid-gated activation: x * sigmoid(1.702 * x)."""
